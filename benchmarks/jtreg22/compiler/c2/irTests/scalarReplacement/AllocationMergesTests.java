...
public class AllocationMergesTests {
    ...
    int testGlobalEscape_C2(int x, int y) {
        return testGlobalEscape(x, y);
    }

    @DontCompile
    int testGlobalEscape_Interp(int x, int y) {
        return testGlobalEscape(x, y);
    }
    ...
    @Test
    @IR(counts = {IRNode.ALLOC, "1"})
    int testArgEscape_C2(int x, int y) {
        return testArgEscape(x, y);
    }

    @DontCompile
    int testArgEscape_Interp(int x, int y) {
        return testArgEscape(x, y);
    }
    ...
    int testEscapeInCallAfterMerge_C2(boolean cond, boolean cond2, int x, int y) {
        return testEscapeInCallAfterMerge(cond, cond2, x, y);
    }

    @DontCompile
    int testEscapeInCallAfterMerge_Interp(boolean cond, boolean cond2, int x, int y) {
        return testEscapeInCallAfterMerge(cond, cond2, x, y);
    }
    ...
    int testNoEscapeWithWriteInLoop_C2(boolean cond, boolean cond2, int x, int y) {
        return testNoEscapeWithWriteInLoop(cond, cond2, x, y);
    }

    @DontCompile
    int testNoEscapeWithWriteInLoop_Interp(boolean cond, boolean cond2, int x, int y) {
        return testNoEscapeWithWriteInLoop(cond, cond2, x, y);
    }
    ...
    int testPollutedWithWrite_C2(boolean cond, int l) {
        return testPollutedWithWrite(cond, l);
    }

    @DontCompile
    int testPollutedWithWrite_Interp(boolean cond, int l) {
        return testPollutedWithWrite(cond, l);
    }
    ...
    int testPollutedPolymorphic_C2(boolean cond, int l) {
        return testPollutedPolymorphic(cond, l);
    }

    @DontCompile
    int testPollutedPolymorphic_Interp(boolean cond, int l) {
        return testPollutedPolymorphic(cond, l);
    }
    ...
    int testMergedLoadAfterDirectStore_C2(boolean cond, int x, int y) {
        return testMergedLoadAfterDirectStore(cond, x, y);
    }

    @DontCompile
    int testMergedLoadAfterDirectStore_Interp(boolean cond, int x, int y) {
        return testMergedLoadAfterDirectStore(cond, x, y);
    }
    ...
    @IR(counts = {IRNode.ALLOC, "3"})
        ...
        //  - p2 is ArgEscape
    int testMergedAccessAfterCallWithWrite_C2(boolean cond, int x, int y) {
        return testMergedAccessAfterCallWithWrite(cond, x, y);
    }

    @DontCompile
    int testMergedAccessAfterCallWithWrite_Interp(boolean cond, int x, int y) {
        return testMergedAccessAfterCallWithWrite(cond, x, y);
    }
    ...
    int testLoadAfterTrap_C2(boolean cond, int x, int y) {
        return testLoadAfterTrap(cond, x, y);
    }

    @DontCompile
    int testLoadAfterTrap_Interp(boolean cond, int x, int y) {
        return testLoadAfterTrap(cond, x, y);
    }
    ...
    int testCondAfterMergeWithNull_C2(boolean cond1, boolean cond2, int x, int y) {
        return testCondAfterMergeWithNull(cond1, cond2, x, y);
    }

    @DontCompile
    int testCondAfterMergeWithNull_Interp(boolean cond1, boolean cond2, int x, int y) {
        return testCondAfterMergeWithNull(cond1, cond2, x, y);
    }
    ...
    int testLoadAfterLoopAlias_C2(boolean cond, int x, int y) {
        return testLoadAfterLoopAlias(cond, x, y);
    }

    @DontCompile
    int testLoadAfterLoopAlias_Interp(boolean cond, int x, int y) {
        return testLoadAfterLoopAlias(cond, x, y);
    }
    ...
    int testCallTwoSide_C2(boolean cond1, int x, int y) {
        return testCallTwoSide(cond1, x, y);
    }

    @DontCompile
    int testCallTwoSide_Interp(boolean cond1, int x, int y) {
        return testCallTwoSide(cond1, x, y);
    }
    ...
    @IR(counts = {IRNode.ALLOC, "3"})
        ...
        // The allocations won't be removed because 'split_through_phi' won't split the load through the bases.
    int testMergedAccessAfterCallNoWrite_C2(boolean cond, int x, int y) {
        return testMergedAccessAfterCallNoWrite(cond, x, y);
    }

    @DontCompile
    int testMergedAccessAfterCallNoWrite_Interp(boolean cond, int x, int y) {
        return testMergedAccessAfterCallNoWrite(cond, x, y);
    }
    ...
    int testCmpMergeWithNull_Second_C2(boolean cond, int x, int y) {
        return testCmpMergeWithNull_Second(cond, x, y);
    }

    @DontCompile
    int testCmpMergeWithNull_Second_Interp(boolean cond, int x, int y) {
        return testCmpMergeWithNull_Second(cond, x, y);
    }
    ...
    int testObjectIdentity_C2(boolean cond, int x, int y) {
        return testObjectIdentity(cond, x, y);
    }

    @DontCompile
    int testObjectIdentity_Interp(boolean cond, int x, int y) {
        return testObjectIdentity(cond, x, y);
    }
    ...
    int testSubclassesTrapping_C2(boolean c1, boolean c2, int x, int y, int w, int z) {
        return testSubclassesTrapping(c1, c2, x, y, w, z);
    }

    @DontCompile
    int testSubclassesTrapping_Interp(boolean c1, boolean c2, int x, int y, int w, int z) {
        return testSubclassesTrapping(c1, c2, x, y, w, z);
    }
    ...
    @Test
    @IR(counts = {IRNode.ALLOC, "2"})
    int testCmpMergeWithNull_C2(boolean cond, int x, int y) {
        return testCmpMergeWithNull(cond, x, y);
    }

    @DontCompile
    int testCmpMergeWithNull_Interp(boolean cond, int x, int y) {
        return testCmpMergeWithNull(cond, x, y);
    }
    ...
    @IR(counts = {IRNode.ALLOC, "2"})
        ...
        // The other two allocations assigned to 's' won't be removed because they have different type.
    int testSubclasses_C2(boolean c1, boolean c2, int x, int y, int w, int z) {
        return testSubclasses(c1, c2, x, y, w, z);
    }

    @DontCompile
    int testSubclasses_Interp(boolean c1, boolean c2, int x, int y, int w, int z) {
        return testSubclasses(c1, c2, x, y, w, z);
    }
    ...
    int testPartialPhis_C2(boolean cond, int l, int x, int y) {
        return testPartialPhis(cond, l, x, y);
    }

    @DontCompile
    int testPartialPhis_Interp(boolean cond, int l, int x, int y) {
        return testPartialPhis(cond, l, x, y);
    }
    ...
    int testPollutedNoWrite_C2(boolean cond, int l) {
        return testPollutedNoWrite(cond, l);
    }

    @DontCompile
    int testPollutedNoWrite_Interp(boolean cond, int l) {
        return testPollutedNoWrite(cond, l);
    }
    ...
    int testThreeWayAliasedAlloc_C2(boolean cond, int x, int y) {
        return testThreeWayAliasedAlloc(cond, x, y);
    }

    @DontCompile
    int testThreeWayAliasedAlloc_Interp(boolean cond, int x, int y) {
        return testThreeWayAliasedAlloc(cond, x, y);
    }
    ...
    int TestTrapAfterMerge_C2(boolean cond, int x, int y) {
        return TestTrapAfterMerge(cond, x, y);
    }

    @DontCompile
    int TestTrapAfterMerge_Interp(boolean cond, int x, int y) {
        return TestTrapAfterMerge(cond, x, y);
    }
    ...
    Point testNestedObjectsObject_C2(boolean cond, int x, int y) {
        return testNestedObjectsObject(cond, x, y);
    }

    @DontCompile
    Point testNestedObjectsObject_Interp(boolean cond, int x, int y) {
        return testNestedObjectsObject(cond, x, y);
    }
    ...
    int testNestedObjectsNoEscapeObject_C2(boolean cond, int x, int y) {
        return testNestedObjectsNoEscapeObject(cond, x, y);
    }

    @DontCompile
    int testNestedObjectsNoEscapeObject_Interp(boolean cond, int x, int y) {
        return testNestedObjectsNoEscapeObject(cond, x, y);
    }
    ...
    Point[] testNestedObjectsArray_C2(boolean cond, int x, int y) {
        return testNestedObjectsArray(cond, x, y);
    }

    @DontCompile
    Point[] testNestedObjectsArray_Interp(boolean cond, int x, int y) {
        return testNestedObjectsArray(cond, x, y);
    }
    ...
    int testTrappingAfterMerge_C2(boolean cond, int x, int y) {
        return testTrappingAfterMerge(cond, x, y);
    }

    @DontCompile
    int testTrappingAfterMerge_Interp(boolean cond, int x, int y) {
        return testTrappingAfterMerge(cond, x, y);
    }
    ...
    int testSimpleAliasedAlloc_C2(boolean cond, int x, int y) {
        return testSimpleAliasedAlloc(cond, x, y);
    }

    @DontCompile
    int testSimpleAliasedAlloc_Interp(boolean cond, int x, int y) {
        return testSimpleAliasedAlloc(cond, x, y);
    }
    ...
    @IR(failOn = {IRNode.ALLOC})
        // Both merges will be reduced and removed
    int testSimpleDoubleMerge_C2(boolean cond, int x, int y) {
        return testSimpleDoubleMerge(cond, x, y);
    }

    @DontCompile
    int testSimpleDoubleMerge_Interp(boolean cond, int x, int y) {
        return testSimpleDoubleMerge(cond, x, y);
    }
    ...
    int testConsecutiveSimpleMerge_C2(boolean cond1, boolean cond2, int x, int y) {
        return testConsecutiveSimpleMerge(cond1, cond2, x, y);
    }

    @DontCompile
    int testConsecutiveSimpleMerge_Interp(boolean cond1, boolean cond2, int x, int y) {
        return testConsecutiveSimpleMerge(cond1, cond2, x, y);
    }
    ...
    int testDoubleIfElseMerge_C2(boolean cond, int x, int y) {
        return testDoubleIfElseMerge(cond, x, y);
    }

    @DontCompile
    int testDoubleIfElseMerge_Interp(boolean cond, int x, int y) {
        return testDoubleIfElseMerge(cond, x, y);
    }
    ...
    int testNoEscapeWithLoadInLoop_C2(boolean cond, int x, int y) {
        return testNoEscapeWithLoadInLoop(cond, x, y);
    }

    @DontCompile
    int testNoEscapeWithLoadInLoop_Interp(boolean cond, int x, int y) {
        return testNoEscapeWithLoadInLoop(cond, x, y);
    }
    ...
    @IR(failOn = {IRNode.ALLOC})
        // Both allocations will be reduced and scaled
    int testCmpAfterMerge_C2(boolean cond, boolean cond2, int x, int y) {
        return testCmpAfterMerge(cond, cond2, x, y);
    }

    @DontCompile
    int testCmpAfterMerge_Interp(boolean cond, boolean cond2, int x, int y) {
        return testCmpAfterMerge(cond, cond2, x, y);
    }
    ...
    @IR(failOn = {IRNode.ALLOC})
        // Both allocations will be eliminated.
    int testCondAfterMergeWithAllocate_C2(boolean cond1, boolean cond2, int x, int y) {
        return testCondAfterMergeWithAllocate(cond1, cond2, x, y);
    }

    @DontCompile
    int testCondAfterMergeWithAllocate_Interp(boolean cond1, boolean cond2, int x, int y) {
        return testCondAfterMergeWithAllocate(cond1, cond2, x, y);
    }
    ...
    @IR(failOn = {IRNode.ALLOC})
        // Both allocations will be eliminated.
    int testCondLoadAfterMerge_C2(boolean cond1, boolean cond2, int x, int y) {
        return testCondLoadAfterMerge(cond1, cond2, x, y);
    }

    @DontCompile
    int testCondLoadAfterMerge_Interp(boolean cond1, boolean cond2, int x, int y) {
        return testCondLoadAfterMerge(cond1, cond2, x, y);
    }
    ...
    @IR(failOn = {IRNode.ALLOC})
        // The initial allocation is always dead. The other
        // two will be reduced and scaled.
    int testIfElseInLoop_C2() {
        return testIfElseInLoop();
    }

    @DontCompile
    int testIfElseInLoop_Interp() {
        return testIfElseInLoop();
    }
    ...
    int testLoadInCondAfterMerge_C2(boolean cond, int x, int y) {
        return testLoadInCondAfterMerge(cond, x, y);
    }

    @DontCompile
    int testLoadInCondAfterMerge_Interp(boolean cond, int x, int y) {
        return testLoadInCondAfterMerge(cond, x, y);
    }
    ...
    @IR(failOn = {IRNode.ALLOC})
        // Both allocations will be reduced and removed.
    int testLoadInLoop_C2(boolean cond, int x, int y) {
        return testLoadInLoop(cond, x, y);
    }

    @DontCompile
    int testLoadInLoop_Interp(boolean cond, int x, int y) {
        return testLoadInLoop(cond, x, y);
    }
    ...
    int testMergesAndMixedEscape_C2(boolean cond, int x, int y) {
        return testMergesAndMixedEscape(cond, x, y);
    }

    @DontCompile
    int testMergesAndMixedEscape_Interp(boolean cond, int x, int y) {
        return testMergesAndMixedEscape(cond, x, y);
    }
    ...
    @Test
    @IR(counts = {IRNode.ALLOC, "<=1"})
    int testSRAndNSR_NoTrap_C2(boolean cond1, int x, int y) {
        return testSRAndNSR_NoTrap(cond1, x, y);
    }

    @DontCompile
    int testSRAndNSR_NoTrap_Interp(boolean cond1, int x, int y) {
        return testSRAndNSR_NoTrap(cond1, x, y);
    }
    ...
    @Test
    @IR(counts = {IRNode.ALLOC, "<=1"})
    int testSRAndNSR_Trap_C2(boolean is_c2, boolean cond1, boolean cond2, int x, int y) {
        return testSRAndNSR_Trap(is_c2, cond1, cond2, x, y);
    }

    @DontCompile
    int testSRAndNSR_Trap_Interp(boolean is_c2, boolean cond1, boolean cond2, int x, int y) {
        return testSRAndNSR_Trap(is_c2, cond1, cond2, x, y);
    }
    ...
    char testString_one_C2(boolean cond1) {
        return testString_one(cond1);
    }

    @DontCompile
    char testString_one_Interp(boolean cond1) {
        return testString_one(cond1);
    }
    ...
    @Test
    @IR(counts = {IRNode.ALLOC, "0"})
    char testString_two_C2(boolean cond1) {
        return testString_two(cond1);
    }

    @DontCompile
    char testString_two_Interp(boolean cond1) {
        return testString_two(cond1);
    }
