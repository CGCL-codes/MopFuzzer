...
//        }
    ...
    void test() throws NoSuchMethodException, InvocationTargetException, IllegalAccessException {
        ...
        boolean pass = true;
        Method m = CEETest.class.getDeclaredMethod("doInt");

        for (int i = 0; (i < WarmUp) & pass; i++) {
//            pass = pass & (boolean) m.invoke(this);
            pass = pass & doBoolean();
            pass = pass & doByte();
            pass = pass & doChar();
            pass = pass & doShort();
...
//        } else {
//            int a = 0;
//            throw new RuntimeException("CEETest FAILed in " + duration + " ms.");
//        }

    }

    public boolean doInt() {
