...
public class NullPointerChecker extends MutateTemplate_B {
    ...
    public void generatePatches() {
        ...
        if (!vars.isEmpty()) {
            ...
            if (!vars.isEmpty()) {
                for (String var : vars) {
                    ...
                    suspCodeEndPos = ContextReader.identifyRelatedStatements(suspCodeTree, List.of(var), this.suspCodeEndPos).getFirst();
        ...
        if (!suspNullExpStrs.isEmpty()) {
            ...
            int suspCodeEndPos = ContextReader.identifyRelatedStatements(suspCodeTree, List.of(expStr), this.suspCodeEndPos).getFirst();
